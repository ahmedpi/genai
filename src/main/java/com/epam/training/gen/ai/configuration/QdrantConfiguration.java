 ...
 * <p>
 * This configuration defines a bean that provides a client for interacting with a Qdrant service.
 * The client is built using gRPC to connect to a Qdrant instance running at the specified host and
 * port.
 */
